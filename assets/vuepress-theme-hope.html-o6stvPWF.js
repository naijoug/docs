import{_ as l}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as o,o as i,c,a as p,b as n,e,d as a,f as t}from"./app-9TEjBeIh.js";const d={},r=n("h2",{id:"reference",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#reference","aria-hidden":"true"},"#"),e(" reference")],-1),u={href:"https://theme-hope.vuejs.press",target:"_blank",rel:"noopener noreferrer"},m={href:"https://github.com/vuepress-theme-hope/vuepress-theme-hope",target:"_blank",rel:"noopener noreferrer"},k=n("blockquote",null,[n("p",null,"A vuepress theme with tons of features✨")],-1),v=t(`<h2 id="" tabindex="-1"><a class="header-anchor" href="#" aria-hidden="true">#</a></h2><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code>  <span class="token punctuation">---</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="markdown-增强" tabindex="-1"><a class="header-anchor" href="#markdown-增强" aria-hidden="true">#</a> <code>Markdown</code> 增强</h2><h3 id="codetabs-代码块分组" tabindex="-1"><a class="header-anchor" href="#codetabs-代码块分组" aria-hidden="true">#</a> <code>codetabs</code> - “代码块分组”</h3>`,4),b={href:"https://theme-hope.vuejs.press/zh/guide/markdown/code-tabs.html",target:"_blank",rel:"noopener noreferrer"},h=n("p",null,"这个功能很好解决了，多种编程语言对于同一解决方案的描述，可以很方便的组织界面结构。",-1),_=n("blockquote",null,[n("p",null,"示例：")],-1),f=n("pre",null,[n("code",null,`  ::: codetab
  @tab java
  \`\`\`java
...
:::
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,5),x=n("h3",{id:"include-导入",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#include-导入","aria-hidden":"true"},"#"),e(),n("code",null,"@include:"),e(" - “导入”")],-1),q={href:"https://theme-hope.vuejs.press/zh/guide/markdown/include.html",target:"_blank",rel:"noopener noreferrer"},j=t(`<p>这个功能可以将其它的 <code>markdown</code> 整个文件导入到当前 <code>markdown</code> 文件中，或者也导入其它 <code>markdown</code> 文件区域。</p><p>有点类似编程语言中的 “宏定义”，当生成静态网页时，会将导入部分替换话为对应导入内容。</p><p>这样可以很方便的组织文件结构，也可以很方便的复用文件内容。</p><blockquote><p><code>markdwon</code> 文件 : <code>test.md</code></p></blockquote><div class="language-markdown line-numbers-mode" data-ext="md"><pre class="language-markdown"><code><span class="token title important"><span class="token punctuation">#</span> one</span>
...
<span class="token comment">&lt;!-- #region #endregion 用于包裹标记的区域 --&gt;</span>
// #region tag
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>导入整个文件</p></blockquote><p><code>&lt;!-- @include: ./test.md --&gt;</code></p><blockquote><p>导入指定行数</p></blockquote><p><code>&lt;!-- @include: ./test.md{2-4} --&gt;</code> : 导入 2 ~ 4 行内容</p><p><code>&lt;!-- @include: ./test.md{2-} --&gt;</code> : 导入 2 行后面的所有内容</p><p><code>&lt;!-- @include: ./test.md{-4} --&gt;</code> : 导入 4 行之前的所有内容</p><blockquote><p>导入指定区域</p></blockquote><p><code>&lt;!-- @include: ./test.md#tag --&gt;</code> : 导入 tag 标记的区域内容</p>`,13),z=n("h2",{id:"案例",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#案例","aria-hidden":"true"},"#"),e(" 案例")],-1),B={href:"https://theme-hope.vuejs.press/zh/demo/",target:"_blank",rel:"noopener noreferrer"},V=n("hr",null,null,-1),J={href:"https://javaguide.cn",target:"_blank",rel:"noopener noreferrer"},M=n("blockquote",null,[n("p",null,"Java学习+面试指南」一份涵盖大部分 Java 程序员所需要掌握的核心知识。准备 Java 面试，首选 JavaGuide！")],-1),N={href:"https://www.macrozheng.com/",target:"_blank",rel:"noopener noreferrer"},E=n("blockquote",null,[n("p",null,"mall学习教程，架构、业务、技术要点全方位解析。mall项目（60k+star）是一套电商系统，使用现阶段主流技术实现。涵盖了SpringBoot、MyBatis、Elasticsearch、RabbitMQ、Redis、MongoDB、Mysql等技术，采用Docker容器化部署。")],-1),H={href:"https://newzone.top/",target:"_blank",rel:"noopener noreferrer"},L=n("blockquote",null,[n("p",null,"开源工具、效率方法、心理学探索的自我提升笔记")],-1);function D(I,S){const s=o("ExternalLinkIcon");return i(),c("div",null,[p(" more "),r,n("ul",null,[n("li",null,[n("a",u,[e("VuePress Theme Hope"),a(s)]),e(" 👉🏻 "),n("a",m,[e("🐙"),a(s)]),k])]),v,n("ul",null,[n("li",null,[n("p",null,[n("a",b,[e("docs - 代码块分组"),a(s)])]),h,_,f])]),g,n("ul",null,[n("li",null,[n("p",null,[n("a",y,[e("docs - 提示容器"),a(s)])]),w])]),x,n("ul",null,[n("li",null,[n("p",null,[n("a",q,[e("docs - 导入文件"),a(s)])]),j])]),z,n("ul",null,[n("li",null,[n("a",B,[e("docs - 案例"),a(s)])])]),V,n("ul",null,[n("li",null,[n("a",J,[e("JavaGuide"),a(s)]),M]),n("li",null,[n("a",N,[e("mall学习教程"),a(s)]),E]),n("li",null,[n("a",H,[e("LearnData-开源笔记"),a(s)]),L])])])}const G=l(d,[["render",D],["__file","vuepress-theme-hope.html.vue"]]);export{G as default};
