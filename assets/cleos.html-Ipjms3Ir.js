import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as e,f as a}from"./app-NiSSZH60.js";const c={},i=a(`<h1 id="cleos" tabindex="-1"><a class="header-anchor" href="#cleos" aria-hidden="true">#</a> cleos</h1><blockquote><p>cli eos</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># cleos [OPTIONS] SUBCOMMAND</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,35),t=[i];function o(l,m){return s(),e("div",null,t)}const r=n(c,[["render",o],["__file","cleos.html.vue"]]);export{r as default};
