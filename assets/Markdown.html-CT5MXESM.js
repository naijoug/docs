...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,33);function f(T,S){const s=o("ExternalLinkIcon");return r(),d("div",null,[c,n("ul",null,[n("li",null,[n("a",p,[a("Markdown 官网语法"),e(s)])]),n("li",null,[n("a",u,[a("Markdown 基本语法"),e(s)])]),n("li",null,[n("a",m,[a("Markdown 中文网"),e(s)])])]),v,n("ul",null,[n("li",null,[n("a",k,[a("MWeb"),e(s)])]),n("li",null,[n("a",b,[a("MacDown"),e(s)])]),n("li",null,[n("a",h,[a("MarkdownPad"),e(s)])])]),g,n("h2",y,[q,a(),n("a",w,[a("Mermaid"),e(s)])]),x])}const C=i(l,[["render",f],["__file","Markdown.html.vue"]]);export{C as default};
