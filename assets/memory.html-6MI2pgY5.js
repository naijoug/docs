import{_ as p}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as o,o as c,c as l,a as i,b as n,e as s,d as t,f as a}from"./app-70ciXxLL.js";const u={},r=n("blockquote",null,[n("p",null,[n("code",null,"Memory Management"),s(" - “内存管理”")])],-1),k=a('<h2 id="引用计数" tabindex="-1"><a class="header-anchor" href="#引用计数" aria-hidden="true">#</a> 引用计数</h2><p><code>MRC</code>(Manual Reference Counting) : 手动引用计数。需要程序员自己申请(<code>retain</code>)和释放(<code>release</code>、<code>autorelease</code>)</p><p><code>ARC</code>(Automatic Reference Counting) : 自动引用计数，是 iOS 中的内存管理技术。编译器在编译阶段，在代码需要内存管理的地方插入内存管理操作(<code>retain</code>、<code>release</code>、<code>autorelase</code>)，当对象引用计数为 0 时，在 <code>dealloc</code> 的时候，会释放掉对象占用内存，自动地管理对象的生命周期。</p><p><code>autorelease</code> 用于延迟对象的释放。正常情况下，如果申请的对象超出作用域会释放。而使用 <code>autorelease</code> 的对象，会加入自动释放池中，延迟对象的释放时机。</p><h2 id="weak-弱引用" tabindex="-1"><a class="header-anchor" href="#weak-弱引用" aria-hidden="true">#</a> <code>weak</code> - “弱引用”</h2><h3 id="sidetable" tabindex="-1"><a class="header-anchor" href="#sidetable" aria-hidden="true">#</a> SideTable</h3>',6),d={href:"https://github.com/apple-oss-distributions/objc4/blob/objc4-876/runtime/NSObject-private.h#L47",target:"_blank",rel:"noopener noreferrer"},v=a(`<div class="language-objc line-numbers-mode" data-ext="objc"><pre class="language-objc"><code><span class="token comment">// NSObject-private.h#L47</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="weak-table-t" tabindex="-1"><a class="header-anchor" href="#weak-table-t" aria-hidden="true">#</a> weak_table_t</h3>`,2),m={href:"https://github.com/apple-oss-distributions/objc4/blob/objc4-876/runtime/objc-weak.h#L119",target:"_blank",rel:"noopener noreferrer"},b=a(`<div class="language-objc line-numbers-mode" data-ext="objc"><pre class="language-objc"><code><span class="token comment">// objc-weak.h#L119</span>
...
<span class="token keyword">struct</span> weak_entry_t <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="objc-storestrong" tabindex="-1"><a class="header-anchor" href="#objc-storestrong" aria-hidden="true">#</a> objc_storeStrong</h3>`,2),h={href:"https://github.com/apple-oss-distributions/objc4/blob/objc4-876/runtime/NSObject.mm#L275",target:"_blank",rel:"noopener noreferrer"},_=a(`<div class="language-objc line-numbers-mode" data-ext="objc"><pre class="language-objc"><code><span class="token comment">// NSObject.mm#L275</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="objc-storeweak" tabindex="-1"><a class="header-anchor" href="#objc-storeweak" aria-hidden="true">#</a> objc_storeWeak</h3>`,2),w={href:"https://github.com/apple-oss-distributions/objc4/blob/objc4-876/runtime/NSObject.mm#L403",target:"_blank",rel:"noopener noreferrer"},f=a(`<div class="language-objc line-numbers-mode" data-ext="objc"><pre class="language-objc"><code><span class="token comment">// NSObject.mm#L403</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h2 id="autoreleasepool-自动释放池" tabindex="-1"><a class="header-anchor" href="#autoreleasepool-自动释放池" aria-hidden="true">#</a> <code>AutoreleasePool</code> - “自动释放池”</h2><h3 id="autoreleasepoolpage" tabindex="-1"><a class="header-anchor" href="#autoreleasepoolpage" aria-hidden="true">#</a> AutoreleasePoolPage</h3>`,4),g={href:"https://github.com/apple-oss-distributions/objc4/blob/objc4-876/runtime/NSObject.mm#L659",target:"_blank",rel:"noopener noreferrer"},y=a(`<div class="language-objc line-numbers-mode" data-ext="objc"><pre class="language-objc"><code><span class="token comment">// NSObject.mm#L659</span>
...
<span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">endif</span></span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="autoreleasepoolpagedata" tabindex="-1"><a class="header-anchor" href="#autoreleasepoolpagedata" aria-hidden="true">#</a> AutoreleasePoolPageData</h3>`,2),j={href:"https://github.com/apple-oss-distributions/objc4/blob/objc4-876/runtime/NSObject-internal.h#L133",target:"_blank",rel:"noopener noreferrer"},O=a(`<div class="language-objc line-numbers-mode" data-ext="objc"><pre class="language-objc"><code><span class="token comment">// NSObject-internal.h#L133</span>
...
<span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">endif</span></span>
	...
	<span class="token punctuation">}</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,1);function P(T,S){const e=o("ExternalLinkIcon");return c(),l("div",null,[r,i(" more "),k,n("blockquote",null,[n("p",null,[n("a",d,[s("👉🏻"),t(e)])])]),v,n("blockquote",null,[n("p",null,[n("a",m,[s("👉🏻"),t(e)])])]),b,n("blockquote",null,[n("p",null,[n("a",h,[s("👉🏻"),t(e)])])]),_,n("blockquote",null,[n("p",null,[n("a",w,[s("👉🏻"),t(e)])])]),f,n("blockquote",null,[n("p",null,[n("a",g,[s("👉🏻"),t(e)])])]),y,n("blockquote",null,[n("p",null,[n("a",j,[s("👉🏻"),t(e)])])]),O])}const R=p(u,[["render",P],["__file","memory.html.vue"]]);export{R as default};
