...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,33);function S(_,A){const s=o("ExternalLinkIcon");return r(),l("div",null,[p,d(" more "),u,n("ul",null,[n("li",null,[n("a",m,[a("Markdown 官网语法"),e(s)])]),n("li",null,[n("a",v,[a("Markdown 基本语法"),e(s)])]),n("li",null,[n("a",k,[a("Markdown 中文网"),e(s)])])]),b,n("ul",null,[n("li",null,[n("a",h,[a("MWeb"),e(s)])]),n("li",null,[n("a",g,[a("MacDown"),e(s)])]),n("li",null,[n("a",y,[a("MarkdownPad"),e(s)])])]),q,n("h2",w,[x,a(),n("a",f,[a("Mermaid"),e(s)])]),T])}const B=i(c,[["render",S],["__file","markdown.html.vue"]]);export{B as default};
