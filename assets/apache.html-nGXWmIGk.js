import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as a,c as s,a as n,f as c}from"./app-R4SeOK86.js";const l={},i=c(`<h2 id="usage" tabindex="-1"><a class="header-anchor" href="#usage" aria-hidden="true">#</a> Usage</h2><ul><li><p>macOS</p><ul><li>系统级根目录 : <code>/Library/WebServer/Documents</code><ul><li>配置文件 : <code>/etc/apache2/httpd.conf</code></li></ul></li><li>用户级别根目录 : <code>/Users/\${user}/Sites</code><ul><li>配置文件 : <code>/etc/apache2/users/\${user}.conf</code></li></ul></li><li>apache 日志目录 : <code>/var/log/apache2</code></li></ul></li><li><p>ubuntu</p><ul><li>默认根目录 : <code>/var/www/html/index.html</code></li><li>配置文件目录 : <code>/etc/apache2/apache2.conf</code></li></ul></li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># macOS</span>
