import{_ as l}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as i,o as t,c as d,b as n,e,d as a,f as c}from"./app-NiSSZH60.js";const r={},o=n("h1",{id:"gradle",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#gradle","aria-hidden":"true"},"#"),e(" Gradle")],-1),p=n("h2",{id:"reference",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#reference","aria-hidden":"true"},"#"),e(" Reference")],-1),m={href:"https://github.com/gradle/gradle",target:"_blank",rel:"noopener noreferrer"},u={href:"https://github.com/DONGChuan/GradleUserGuide",target:"_blank",rel:"noopener noreferrer"},v=c(`<h2 id="usage" tabindex="-1"><a class="header-anchor" href="#usage" aria-hidden="true">#</a> Usage</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ gradle <span class="token parameter variable">-q</span> hello <span class="token comment"># 执行 hello.gradle 脚本</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,5);function b(k,h){const s=i("ExternalLinkIcon");return t(),d("div",null,[o,p,n("ul",null,[n("li",null,[n("a",m,[e("gradle"),a(s)]),e(" : Adaptable, fast automation for all")]),n("li",null,[n("a",u,[e("Gradle User Guide 中文版"),a(s)])])]),v])}const f=l(r,[["render",b],["__file","Gradle.html.vue"]]);export{f as default};
