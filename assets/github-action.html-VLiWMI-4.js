import{_ as i}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as c,o,c as l,a as n,b as s,d as e,f as t}from"./app-VvAvirbM.js";const p={},u=t('<h1 id="github-actions" tabindex="-1"><a class="header-anchor" href="#github-actions" aria-hidden="true">#</a> Github Actions</h1><h2 id="github-token" tabindex="-1"><a class="header-anchor" href="#github-token" aria-hidden="true">#</a> GITHUB_TOKEN</h2><h2 id="actions" tabindex="-1"><a class="header-anchor" href="#actions" aria-hidden="true">#</a> Actions</h2>',3),r={href:"https://github.com/crazy-max/ghaction-github-pages",target:"_blank",rel:"noopener noreferrer"},d=n("blockquote",null,[n("p",null,[s("登录 GitHub 进入项目 "),n("code",null,"Settings->Actions->General->Workflow permissions"),s(" 修改为 "),n("code",null,"Read and write permissions")])],-1),k={href:"https://github.com/Yikun/hub-mirror-action",target:"_blank",rel:"noopener noreferrer"},m=t(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 1&gt; 创建 ssh 秘钥对 </span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2);function b(v,h){const a=c("ExternalLinkIcon");return o(),l("div",null,[u,n("ul",null,[n("li",null,[n("a",r,[s("ghaction-github-pages"),e(a)]),s(" : 部署到 GitHub Pages")])]),d,n("ul",null,[n("li",null,[n("a",k,[s("hub-mirror-action"),e(a)]),s(" : 同步 GitHub 到 Gitee")])]),m])}const y=i(p,[["render",b],["__file","github-action.html.vue"]]);export{y as default};
