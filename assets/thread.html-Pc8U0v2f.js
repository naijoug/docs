...
</code></pre>`,21);function p(_,m){const d=o("ExternalLinkIcon");return n(),h("div",null,[c(" more "),s,t("ul",null,[t("li",null,[t("a",u,[e("怎样理解阻塞非阻塞与同步异步的区别？"),r(d)])]),t("li",null,[t("a",b,[e("为什么Linux下没有真正的异步IO模型？"),r(d)])])]),f])}const g=a(l,[["render",p],["__file","thread.html.vue"]]);export{g as default};
