...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,33);function D(M,B){const s=o("ExternalLinkIcon");return r(),l("div",null,[p,d(" more "),u,n("ul",null,[n("li",null,[n("a",m,[a("Markdown 官网语法"),e(s)])]),n("li",null,[n("a",v,[a("Markdown 基本语法"),e(s)])]),n("li",null,[n("a",k,[a("Markdown 中文网"),e(s)])])]),b,n("ul",null,[n("li",null,[n("a",h,[a("MWeb"),e(s)])]),n("li",null,[n("a",g,[a("MarkdownPad"),e(s)])]),n("li",null,[n("a",y,[a("Milkdown"),e(s)]),a(" 👉🏻 "),n("a",q,[a("🐙"),e(s)]),w]),n("li",null,[a("[MacDown][https://macdown.uranusjr.com/] 👉🏻 "),n("a",x,[a("🐙"),e(s)]),f])]),T,n("h2",_,[S,a(),n("a",A,[a("Mermaid"),e(s)])]),C])}const $=i(c,[["render",D],["__file","markdown.html.vue"]]);export{$ as default};
