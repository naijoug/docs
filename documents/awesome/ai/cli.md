...
- [💯 learn-claude-code](https://learn.shareai.run) 👉🏻 [🐙](https://github.com/shareAI-lab/learn-claude-code)
...
- [Claude Code Base](https://ccb.agent-aura.top/)
    > Claude Code 资料站。
...
- [Factory](https://factory.ai/) 👉🏻 [🐙](https://github.com/Factory-AI/factory)
    > Factory - Agent-Native Software Development
- [blackbox](https://docs.blackbox.ai/) 👉🏻 [🐙](https://github.com/blackboxaicode/cli)
    > BLACKBOX CLI for running Multi-Agents locally and a Judge to select the best task implementation
...
- [CLI Proxy API](https://help.router-for.me/) 👉🏻 [🐙](https://github.com/router-for-me/CLIProxyAPI)
...
- [quotio](https://www.quotio.dev/) 👉🏻 [🐙](https://github.com/nguyenphutrong/quotio)
...
- [Everything Claude Code](https://ecc.tools/) 👉🏻 [🐙](https://github.com/affaan-m/everything-claude-code) 
