...
- [Role State Acceptance Checklist](role-state-acceptance-checklist.md)
...
- [Agent 任务先写权限与证据卡](agent-task-permission-evidence-card.md)
...
- [Trigger Examples Adapter Score 闭环](trigger-examples-adapter-score-loop.md)
- [Trigger 规则收窄闭环](trigger-rule-tightening-loop.md)
...
- [AI 编程审查 Audit Result 填写样例](ai-coding-audit-result-log-filled-example.md)
...
- [Agent Cron 门禁自测覆盖矩阵](agent-cron-gate-selftest-coverage-matrix.md)
